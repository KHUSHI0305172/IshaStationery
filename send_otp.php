...
if($type=='email'){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="ishastationery@gmail.com";
	$mail->Password="Password@123";
	$mail->SetFrom('ishastationery@gmail.com');
...
if($type=='mobile'){
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_HTTPHEADER => array(
		"authorization: hPlvxrLBjgbX81wJdGZTnR0CeMc9aEuKmypsi43qtY2UzD7QfNnmgV56BCy8rUxqYeabhpcv9Zut2jMF",
		"accept: */*",
